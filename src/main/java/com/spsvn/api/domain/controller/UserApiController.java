...
import com.spsvn.api.domain.ClientContextHolder;
import com.spsvn.api.domain.repository.UserApi;
import com.spsvn.api.domain.model.User;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.spsvn.api.domain.repository.jpa.UserRepository;
...
public class UserApiController implements UserApi {
    ...
    public ResponseEntity<Void> createUser(@ApiParam(value = "Created user object", required=true )  @Valid @RequestBody User body) {
        if (body.getClientSpecific() != null) {
            try {
                ClientContextHolder.getCurrentClientContext().setClient(Client.valueOf(body.getClientSpecific()));
